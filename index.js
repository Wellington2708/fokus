...
const imagensPausarOuComeçar = document.querySelector(".app__card-primary-butto-icon");
...
function iniciarOuPausar() {
    ...
    imagensPausarOuComeçar.src = '/imagens/pause.png';
...
function zerar(){
    ...
    imagensPausarOuComeçar.src = '/imagens/play_arrow.png';
